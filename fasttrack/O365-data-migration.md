...
|**Novell GroupWise** |Migração usando ferramentas nativas de IMAP4| Emails | Regras <br/> Conversão de proxies/representantes/ACL (lista de controle de acesso) <br/> Assinaturas <br/> Pastas de pesquisa <br/> Usuários bloqueados ou inativos <br/> Dados de arquivo morto <br/> Itens criptografados ou direitos gerenciados <br/> Itens corrompidos <br/> Coexistência de calendário <br/> Usuários habilitados para email <br/> Contatos de caixas de correio <br/> Grupos pessoais <br/> Calendário <br/> Tarefas <br/> Qualquer email que excede o limite de tamanho da mensagem |
