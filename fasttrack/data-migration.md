...
<br />
<strong>Observação:</strong> Seu ambiente do G Suite deve atender aos pré-requisitos descritos em [Perform a G Suite migration](/Exchange/mailbox-migration/perform-g-suite-migration).</td>
