...
Os Especialistas do FastTrack têm as seguintes responsabilidades durante a integração. Eles podem ser adicionais ou substituir as atividades definidas em [processo e expectativas](process-and-expectations.md).
  
## <a name="general"></a>Geral

- Fornecer assistência remota para o desenvolvimento, a implementação e as atividades de configuração necessárias do planejamento de sucesso, conforme detalhado em [produtos e recursos](products-and-capabilities.md).
...
Você tem as responsabilidades a seguir durante a integração. Além das responsabilidades definidas em [processo e expectativas](process-and-expectations.md). 
